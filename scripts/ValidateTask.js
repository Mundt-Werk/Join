...
function createSubtaskElements(subtaskText) {
  ...
  return { listItem, subtaskContent, editInput, subtaskButtons };
}
function createSubtaskButtons(listItem, subtaskContent, editInput, subtaskButtons) {
...
function addSubtask() {
 ...
 const { listItem, subtaskContent, editInput, subtaskButtons } = createSubtaskElements(subtaskText);
  createSubtaskButtons(listItem, subtaskContent, editInput, subtaskButtons);

  listItem.append(subtaskContent, editInput, subtaskButtons);
